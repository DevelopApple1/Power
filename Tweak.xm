...
// Custom tint colour
UIColor* tintColor;
// What style the user chose (Default (0), Modern (1))
int style;
...
CGRect maskRect = CGRectMake(self.view.frame.size.width - 405, self.view.frame.size.height / 2 - 360, 400, 80);
...
CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
CGRect maskRect = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 210, 100, 360);
// Create a path with the rectangle in it.
CGPathRef path = CGPathCreateWithRoundedRect(maskRect, 15, 15, NULL);
// Set the path to the mask layer.
maskLayer.path = path;
...
CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
CGRect maskRect = CGRectMake(self.view.frame.size.width - 550, self.view.frame.size.height / 2 - 410, 900, 960);
// Create a path with the rectangle in it.
CGPathRef path = CGPathCreateWithRoundedRect(maskRect, 15, 15, NULL);
// Set the path to the mask layer.
maskLayer.path = path;
...
NSString* power1 = [bundle pathForResource:@"power1" ofType:@"png"];
NSString* reboot1 = [bundle pathForResource:@"reboot1" ofType:@"png"];
NSString* respring1 = [bundle pathForResource:@"respring1" ofType:@"png"];
NSString* safemode1 = [bundle pathForResource:@"safemode1" ofType:@"png"];
NSString* close1 = [bundle pathForResource:@"close1" ofType:@"png"];

NSString* power2 = [bundle pathForResource:@"power2" ofType:@"png"];
NSString* reboot2 = [bundle pathForResource:@"reboot2" ofType:@"png"];
NSString* respring2 = [bundle pathForResource:@"respring2" ofType:@"png"];
NSString* safemode2 = [bundle pathForResource:@"safemode2" ofType:@"png"];
NSString* close2 = [bundle pathForResource:@"close2" ofType:@"png"];
...
if(defaultTheme == 0) {
rebootButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 130, 60, 60);
[rebootButton setImage:[UIImage imageWithContentsOfFile: reboot] forState:UIControlStateNormal];
[rebootButton setTitle:@"Reboot" forState:UIControlStateNormal];
[rebootButton addTarget:self action:@selector(reboot) forControlEvents:UIControlEventTouchUpInside];
rebootButton.tintColor = LCPParseColorString(@"#ffffff", @"#ffffff");
} else if (defaultTheme == 1) {
rebootButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 130, 60, 60);
[rebootButton setImage:[UIImage imageWithContentsOfFile: reboot1] forState:UIControlStateNormal];
[rebootButton setTitle:@"Reboot" forState:UIControlStateNormal];
[rebootButton addTarget:self action:@selector(reboot) forControlEvents:UIControlEventTouchUpInside];
rebootButton.tintColor = LCPParseColorString(@"#72cb54", @"#72cb54");
} else if (defaultTheme == 2) {
rebootButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 130, 60, 60);
...
rebootButton.frame = CGRectMake(self.view.frame.size.width - 270, self.view.frame.size.height / 2 - 200, 10, 100);
[rebootButton setImage:[UIImage imageWithContentsOfFile: power1] forState:UIControlStateNormal];
[rebootButton setTitle:@"Reboot" forState:UIControlStateNormal];
[rebootButton addTarget:self action:@selector(reboot) forControlEvents:UIControlEventTouchUpInside];
rebootButton.tintColor = LCPParseColorString(@"#72cb54", @"#72cb54");
}
...
powerButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 200, 60, 60);
[powerButton setImage:[UIImage imageWithContentsOfFile: power] forState:UIControlStateNormal];
[powerButton setTitle:@"PowerOFF" forState:UIControlStateNormal];
[powerButton addTarget:self action:@selector(powerDown) forControlEvents:UIControlEventTouchUpInside];
powerButton.tintColor = LCPParseColorString(@"#ffffff", @"#ffffff");

} else if (defaultTheme == 1) {
powerButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 200, 60, 60);
[powerButton setImage:[UIImage imageWithContentsOfFile: power1] forState:UIControlStateNormal];
[powerButton setTitle:@"PowerOFF" forState:UIControlStateNormal];
[powerButton addTarget:self action:@selector(powerDown) forControlEvents:UIControlEventTouchUpInside];
powerButton.tintColor = LCPParseColorString(@"#e60943", @"#e60943");
} else if (defaultTheme == 2) {
powerButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 200, 60, 60);
[powerButton setImage:[UIImage imageWithContentsOfFile: power2] forState:UIControlStateNormal];
[powerButton setTitle:@"PowerOFF" forState:UIControlStateNormal];
[powerButton addTarget:self action:@selector(powerDown) forControlEvents:UIControlEventTouchUpInside];
powerButton.tintColor = LCPParseColorString(@"#e60943", @"#e60943");
} else if (defaultTheme == 3) {

powerButton.frame = CGRectMake(self.view.frame.size.width - 270, self.view.frame.size.height / 2 - 300, 10, 100);
[powerButton setImage:[UIImage imageWithContentsOfFile: power1] forState:UIControlStateNormal];
[powerButton setTitle:@"PowerOFF" forState:UIControlStateNormal];
[powerButton addTarget:self action:@selector(powerDown) forControlEvents:UIControlEventTouchUpInside];
rebootButton.tintColor = LCPParseColorString(@"#e60943", @"#e60943");
}
}
...
if(defaultTheme == 0) {
respringButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 + 10, 60, 60);
[respringButton setImage:[UIImage imageWithContentsOfFile: respring] forState:UIControlStateNormal];
[respringButton setTitle:@"Respring" forState:UIControlStateNormal];
[respringButton addTarget:self action:@selector(respring) forControlEvents:UIControlEventTouchUpInside];
respringButton.tintColor = LCPParseColorString(@"#ffffff", @"#ffffff");
} else if (defaultTheme == 1) {
respringButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 + 10, 60, 60);
[respringButton setImage:[UIImage imageWithContentsOfFile: respring1] forState:UIControlStateNormal];
[respringButton setTitle:@"Respring" forState:UIControlStateNormal];
[respringButton addTarget:self action:@selector(respring) forControlEvents:UIControlEventTouchUpInside];
respringButton.tintColor = LCPParseColorString(@"#8109e6", @"#8109e6");
} else if (defaultTheme == 2) {
respringButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 + 10, 60, 60);
[respringButton setImage:[UIImage imageWithContentsOfFile: respring2] forState:UIControlStateNormal];
[respringButton setTitle:@"Respring" forState:UIControlStateNormal];
[respringButton addTarget:self action:@selector(respring) forControlEvents:UIControlEventTouchUpInside];
respringButton.tintColor = LCPParseColorString(@"#8109e6", @"#8109e6");
} else if (defaultTheme == 3) {
respringButton.frame = CGRectMake(self.view.frame.size.width - 270, self.view.frame.size.height / 2 - 1, 10, 100);
[respringButton setImage:[UIImage imageWithContentsOfFile: power1] forState:UIControlStateNormal];
[respringButton setTitle:@"Respring" forState:UIControlStateNormal];
[respringButton addTarget:self action:@selector(respring) forControlEvents:UIControlEventTouchUpInside];
respringButton.tintColor = LCPParseColorString(@"#8109e6", @"#8109e6");
}
...
safeModeButton.tintColor = LCPParseColorString(@"#ffffff", @"#ffffff");
if(style == 1 && !overrideTint) {
if(blurStyle == 0) {
...
if(defaultTheme == 0) {
safeModeButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 60, 60, 60);
[safeModeButton setImage:[UIImage imageWithContentsOfFile: safemode] forState:UIControlStateNormal];
[safeModeButton setTitle:@"SafeMode" forState:UIControlStateNormal];
[safeModeButton addTarget:self action:@selector(safemode) forControlEvents:UIControlEventTouchUpInside];
safeModeButton.tintColor = LCPParseColorString(@"#ffffff", @"#ffffff");
...
safeModeButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 60, 60, 60);
[safeModeButton setImage:[UIImage imageWithContentsOfFile: safemode1] forState:UIControlStateNormal];
[safeModeButton setTitle:@"SafeMode" forState:UIControlStateNormal];
[safeModeButton addTarget:self action:@selector(safemode) forControlEvents:UIControlEventTouchUpInside];
safeModeButton.tintColor = LCPParseColorString(@"#e6de09", @"#e6de09");
} else if (defaultTheme == 2) {
safeModeButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 - 60, 60, 60);
[safeModeButton setImage:[UIImage imageWithContentsOfFile: safemode2] forState:UIControlStateNormal];
[safeModeButton setTitle:@"SafeMode" forState:UIControlStateNormal];
[safeModeButton addTarget:self action:@selector(safemode) forControlEvents:UIControlEventTouchUpInside];
safeModeButton.tintColor = LCPParseColorString(@"#e6de09", @"#e6de09");
} else if (defaultTheme == 3) {
safeModeButton.frame = CGRectMake(self.view.frame.size.width - 270, self.view.frame.size.height / 2 - 100, 10, 100);
[safeModeButton setImage:[UIImage imageWithContentsOfFile: power1] forState:UIControlStateNormal];
[safeModeButton setTitle:@"SafeMode" forState:UIControlStateNormal];
[safeModeButton addTarget:self action:@selector(safemode) forControlEvents:UIControlEventTouchUpInside];
safeModeButton.tintColor = LCPParseColorString(@"#e6de09", @"#e6de09");
}
...
if(defaultTheme == 0) {
closeButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 + 80, 60, 60);
[closeButton setImage:[UIImage imageWithContentsOfFile: close] forState:UIControlStateNormal];
[closeButton setTitle:@"Close" forState:UIControlStateNormal];
[closeButton addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
closeButton.tintColor = LCPParseColorString(@"#ffffff", @"#ffffff");
} else if (defaultTheme == 1) {
closeButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 + 80, 60, 60);
[closeButton setImage:[UIImage imageWithContentsOfFile: close1] forState:UIControlStateNormal];
[closeButton setTitle:@"Close" forState:UIControlStateNormal];
[closeButton addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
closeButton.tintColor = LCPParseColorString(@"#1a73e8", @"#1a73e8");
} else if (defaultTheme == 2) {
closeButton.frame = CGRectMake(self.view.frame.size.width - 250, self.view.frame.size.height / 2 + 80, 60, 60);
[closeButton setImage:[UIImage imageWithContentsOfFile: close2] forState:UIControlStateNormal];
[closeButton setTitle:@"Close" forState:UIControlStateNormal];
[closeButton addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
closeButton.tintColor = LCPParseColorString(@"#1a73e8", @"#1a73e8");
} else if (defaultTheme == 3) {
closeButton.frame = CGRectMake(self.view.frame.size.width - 270, self.view.frame.size.height / 2 + 110, 10, 100);
[closeButton setImage:[UIImage imageWithContentsOfFile: power1] forState:UIControlStateNormal];
[closeButton setTitle:@"Close" forState:UIControlStateNormal];
[closeButton addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
...
if(defaultTheme == 0) {
[self.view setBackgroundColor:[UIColor colorWithRed:41/255.0f green:41/255.0f blue:41/255.0f alpha: 0.9f]];
} else if(defaultTheme == 1 || defaultTheme == 2) {
[self.view setBackgroundColor:pixelBg];
} else {
[self.view setBackgroundColor:[UIColor colorWithRed:0/255.0f green:0/255.0f blue:0/255.0f alpha: 1.0f]];
}
}
}
...
defaultTheme1 = [preferences integerForKey:@"kDefaultTheme1"];
